package io.devground.payments.deposit.application.exception.vo;
...
public enum ServiceErrorCode {
	...
	public ServiceException throwServiceException(String... args) {
		String additionalInfo = String.join(", ", args);
		throw new ServiceException(this, additionalInfo);
	}
