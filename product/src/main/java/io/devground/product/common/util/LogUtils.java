package io.devground.product.common.util;
...
import io.devground.product.common.app.AppConfig;
...
public class LogUtils {
	...
	public void logError(JoinPoint joinPoint, Throwable ex) {
		...
		switch (ex) {
			case ProductDomainException exception -> {
				ProductDomainErrorCode errorCode = exception.getErrorCode();
