package io.devground.dbay.order.application.exception;
...
public enum ServiceError {
    ...
    private ServiceError(int httpStatus, String message) {
    ...
    public static ServiceError fromHttpStatus(int httpStatus, String msg) {
        for (ServiceError errorCode : ServiceError.values()) {
