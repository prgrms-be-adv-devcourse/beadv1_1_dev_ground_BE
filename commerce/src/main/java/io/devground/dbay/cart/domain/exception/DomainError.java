...
public enum DomainError {
    ...
    private DomainError(int httpStatus, String message) {
        this.httpStatus = httpStatus;
        this.message = message;
    }

    public DomainException throwDomainException() {
        throw new DomainException(this);
    }

    public DomainException throwDomainException(Throwable cause) {
        throw new DomainException(this, cause);
    }

    public static DomainError fromHttpStatus(int httpStatus, String msg) {
        for (DomainError errorCode : DomainError.values()) {
